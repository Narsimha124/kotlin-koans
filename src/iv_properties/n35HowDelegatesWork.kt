...
fun MyDate.toMillis(): Long {
    ...
    println("Before calander values is : $c")
    c.set(year, month, dayOfMonth, 0, 0, 0)
    c.set(Calendar.MILLISECOND, 0)
    print(" after calander values is : $c,\n add time Zones: ${c.timeZone}, \n  set time is :${c.time} ,\n  time mills : ${c.timeInMillis}")
    return c.timeInMillis
}

fun Long.toDate(): MyDate {
    val c = Calendar.getInstance()
    println(" before toDate values is : $c")
